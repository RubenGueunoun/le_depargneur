        ...
        json.elements do
          json.array! ["message","pluie", "cigarette", "virement"] do |m|
            if m == "message"
              ...
              json.image_url "https://res.cloudinary.com/dyvlvy5co/image/upload/v1559811463/website.png"
            elsif m == "pluie"
              json.title "J'aime pas la pluie"
              json.image_url "https://res.cloudinary.com/dyvlvy5co/image/upload/v1559811320/storm_1.png"
              ...
              json.image_url "https://res.cloudinary.com/dyvlvy5co/image/upload/v1559811331/no-smoking_1.png"
              ...
              json.image_url "https://res.cloudinary.com/dyvlvy5co/image/upload/v1559811341/time-is-money.png"
